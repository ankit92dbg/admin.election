          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-lg-6">
                    <a style="float:right;" class="btn btn-primary" href="add-scheme.php?id=<?php echo $_GET['id']; ?>">Add Scheme</a>
                </div> 
                <div class="col-lg-12">
                        <div class="row">
        ...
        if(page!=''){
          ...
          let search_str = $('#search_str').val()
            $.ajax({  
                  url:"../ajax/scheme.php",  
                  method:"POST",  
                  data:{page:page,total_records:total_records,search_str:search_str,leader_id:"<?php echo $_GET['id']; ?>"},  
                  success:function(data){  
                      $('#dataTbl').html(data);  
                      $('#overlay').hide()
                  }  
