...
include ('../config/conn.php');
 ...
 {  
   ...
   $stateNnamep = $row['state'];
   $state_fetch_name = "select * FROM states where id=".$stateNnamep;
   $state_result = mysqli_query($conn,$state_fetch_name);
   $state_row = mysqli_fetch_array($state_result);
      ...
      <tr>
		...
		<a class="dropdown-item" href="edit-leaders.php?id='.$row['id'].'">'.$row['f_name'].' '.$row['l_name'].'</a>
        </td>
        ...
        <td class="align-middle">
            <div class="dp">
				...
				<li><a class="dropdown-item" href="view-profile.php?id='.$row['id'].'">View Profile</a></li>
                    ...
                    <li><a class="dropdown-item" href="subleaders.php?id='.$row['id'].'">BM</a></li>
